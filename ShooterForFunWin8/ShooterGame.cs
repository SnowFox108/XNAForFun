...
namespace ShooterForFunWin8
{
    ...
    public class ShooterGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            screenWidth = GameSettings.CurrentScreenWidth = _graphics.GraphicsDevice.Viewport.Width;
            screenHeight = GameSettings.CurrentScreenHeight = _graphics.GraphicsDevice.Viewport.Height;
        ...
        {
            ScreenManager.Instance.PreDraw(_spriteBatch);
            ...
            // TODO: Add your drawing code here
            _spriteBatch.Begin();
            _spriteBatch.Draw(_renderTarget, new Vector2(GameSettings.ScreenOffSetX,GameSettings.ScreenOffSetY),
                null, Color.White, 0.0f, Vector2.Zero, GameSettings.ScreenScaleRatio, SpriteEffects.None, 0f);            
            _spriteBatch.End();
